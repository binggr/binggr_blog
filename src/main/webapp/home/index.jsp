...
<nav class="blog-nav layui-header" >
    <div class="layui-container">
        ...
        <a class="blog-logo" href="index.jsp">Binggr<b style="font-size: 16px;">-机会留给有准备的人更多！</b></a>
            ...
            <div class="layui-col-md12">
                <div class="home-tips shadow">
                    ...
                    <div class="home-tips-container">
                        <span style="color: red">欢迎来到binggr的博客</span>
                    </div>
                </div>
            </div>
            <!--左边文章列表-->
                    ...
                    <div class="carousel-box" style="position:relative;background-color: #fff;overflow:hidden">
                        <div style="width:200%" class="banner">
                            <ul>
                                <li style="width:50%">
                                    <a href="#">
                                        <img src="https://img.bizhiku.net/uploads/2018/0928/rezcrrezn4v.jpg?x-oss-process=style/w_870-h_870" />
                                        <p>binggr博客准备上线</p>
                                    </a>
                                </li>
                                <li style="width:50%">
                                    <a href="#">
                                        <img src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=2545868477,686082793&fm=26&gp=0.jpg" />
                                        <p>binggr博客准备上线</p>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="blogerinfo shadow">
                            ...
                            <div class="blogerinfo-contact">
                                ...
                                <a target="_blank" title="给我写信"
                                   href="http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=msdxwu@foxmail.com"
                                   style="text-decoration:none;"><i class="fa fa-envelope fa-2x"></i></a>
                                <a target="_blank" title="GitHub" href="https://github.com/binggr"><i
