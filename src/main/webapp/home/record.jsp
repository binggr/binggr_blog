...
<body>
    ...
    <nav class="blog-nav layui-header">
        <div class="layui-container">
            ...
            <a class="blog-logo" href="home.jsp">Binggr<b style="font-size: 16px;">-机会留给有准备的人更多！</b></a>
                        ...
                        <div class="article-record-content">
                            <div class="article-record-item layui-show">
                                ...
                                <ul>
                                    <li><span class="layui-badge layui-bg-black"
                                            style="margin-right:8px;">10月08日</span><a href="detail.jsp">Visual
                            ...
                            <div class="article-record-item ">
                                ...
                                <ul>
                                    ...
                                    <li><span class="layui-badge layui-bg-black"
                                            style="margin-right:8px;">09月27日</span><a href="detail.jsp">EF
                                            Core进阶之加载关联数据</a></li>
                                    <li><span class="layui-badge layui-bg-black"
                                            style="margin-right:8px;">09月24日</span><a href="detail.jsp">.NET
                                            Core 3.0正式版发布</a></li>
                                    <li><span class="layui-badge layui-bg-black"
